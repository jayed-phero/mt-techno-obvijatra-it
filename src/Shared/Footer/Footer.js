                            ...
                            <div class="px-6">
                                ...
                                <div class="flex mt-6 -mx-2">
                                    ...
                                    <a href="https://www.facebook.com/" target={'_blank'} 
                                        class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 border p-2 border-gray-500 rounded-full h-9 w-9 flex items-center justify-center"
                                        aria-label="Facebook ">
                        ...
                        <div class="mt-6 lg:mt-0 lg:flex-1">
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Courses</a>
