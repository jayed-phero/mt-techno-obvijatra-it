...
const Carrer = () => {
    return (
        <div>
            <section class="bg-white bg-gray-100 rounded-3xl py-9  md:px-0 ">
                <ScrollToTop/>
                <div class="max-w-7xl px-6 py-10 mx-auto">
                    <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Build your <br /> Carrer <span class="underline decoration-blue-500">With us</span></h1>

                    <p class="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus
                    </p>

                    <div class="grid grid-cols-1 gap-5 md:gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                        <div class="w-full max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-light text-gray-800 dark:text-gray-400">Full-Stuck Web Developer</span>
                                <span class="px-3 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full dark:bg-blue-300 dark:text-blue-900">Development</span>
                            </div>

                            <div>
                                <h1 class="mt-2 text-lg font-semibold text-gray-800 dark:text-white">Need Full Stuck Web Developer</h1>
